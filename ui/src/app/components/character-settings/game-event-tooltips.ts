export const GameEventTooltips: Record<string, string> = {
  ...
  "ReceiveTextChannelLocal": "COVAS:NEXT will react to chat received in the Local channel.",
  "ReceiveTextChannelStarSystem": "COVAS:NEXT will react to messages that arrive in the System channel.",
  "ReceiveTextChannelSquadron": "COVAS:NEXT will react to Squadron channel chatter.",
  "ReceiveTextStation": "COVAS:NEXT will react to general station authority announcements.",
  "ReceiveTextPolice": "COVAS:NEXT will react to police/security comms such as scans or warnings.",
  "ReceiveTextDockingChatter": "COVAS:NEXT will react to docking controller chatter.",
  "ReceiveTextMilitary": "COVAS:NEXT will react to messages flagged as military communications.",
  "ReceiveTextCruiseLiner": "COVAS:NEXT will react to passenger liner traffic reports.",
  "ReceiveTextCommuter": "COVAS:NEXT will react to commuter ship chatter.",
  "ReceiveTextAX": "COVAS:NEXT will react to anti-xeno related comms.",
  "ReceiveTextTrader": "COVAS:NEXT will react to trader/peddler transmissions.",
  "ReceiveTextPirate": "COVAS:NEXT will react to pirate threats or demands.",
  "ReceiveTextPowers": "COVAS:NEXT will react to Powerplay-aligned comms.",
  "ReceiveTextMiner": "COVAS:NEXT will react to mining-related chatter.",
  "ReceiveTextExplorer": "COVAS:NEXT will react to explorer/scout chatter.",
  "ReceiveTextSmuggler": "COVAS:NEXT will react to smuggler-related messages.",
  "ReceiveTextPassengerLiner": "COVAS:NEXT will react to passenger liner messages.",
  "ReceiveTextEscort": "COVAS:NEXT will react to escort/convoy protection chatter.",
  "ReceiveTextHitman": "COVAS:NEXT will react to assassin or hitman warnings.",
  "ReceiveTextPropagandist": "COVAS:NEXT will react to propaganda broadcasts.",
  "ReceiveTextRescuer": "COVAS:NEXT will react to rescue/salvage assistance comms.",
  "ReceiveTextConvoy": "COVAS:NEXT will react to convoy coordination messages.",
  "ReceiveTextRefugeeFlotillaWar": "COVAS:NEXT will react to refugee flotilla distress traffic.",
  "ReceiveTextProtester": "COVAS:NEXT will react to protestor slogans or disruption messages.",
  "ReceiveTextOther": "COVAS:NEXT will react to other NPC chatter that does not fit a known family.",
  ...
  "ResourceExtractionDiscovered": "COVAS:NEXT will react when you discover a Resource Extraction Site signal via the FSS.",
  "InstallationDiscovered": "COVAS:NEXT will react when you discover an Installation signal via the FSS.",
  "NavBeaconDiscovered": "COVAS:NEXT will react when you discover a Nav Beacon signal via the FSS.",
  "TouristBeaconDiscovered": "COVAS:NEXT will react when you discover a Tourist Beacon signal via the FSS.",
  "MegashipDiscovered": "COVAS:NEXT will react when you discover a Megaship signal via the FSS.",
  "GenericDiscovered": "COVAS:NEXT will react when you discover a Generic signal via the FSS.",
  "OutpostDiscovered": "COVAS:NEXT will react when you discover an Outpost signal via the FSS.",
  "CombatDiscovered": "COVAS:NEXT will react when you discover a Combat signal via the FSS.",
  "StationDiscovered": "COVAS:NEXT will react when you discover a Station signal via the FSS.",
  "UnknownSignalDiscovered": "COVAS:NEXT will react when you discover an Unknown signal via the FSS.",
