export const GameEventTooltips: Record<string, string> = {
  ...
  "CarrierJumpWarning": "COVAS:NEXT will react 10 minutes before a carrier jump to warn you about the upcoming departure.",
  "CarrierJumpArrived": "COVAS:NEXT will react when your carrier completes its jump. Telling you about the destination system.",
  "CarrierJumpCooldownComplete": "COVAS:NEXT will react when your carrier's jump cooldown ends and it is ready to jump again.",
