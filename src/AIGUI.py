...
game_events = {
    ...
    'Status Events': {
        ...
        'FlightAssistOn': True,
        'FlightAssistOff': True,
        'HardpointsRetracted': True,
        'HardpointsDeployed': True,
        'LightsOff': True,
        'LightsOn': True,
        'CargoScoopRetracted': True,
        'CargoScoopDeployed': True,
        'SilentRunningOff': True,
        'SilentRunningOn': True,
        'FuelScoopStarted': True,
        'FuelScoopEnded': True,
        'SrvHandbrakeOff': True,
        'SrvHandbrakeOn': True,
        'SrvTurretViewConnected': True,
        'SrvTurretViewDisconnected': True,
        'SrvDriveAssistOff': True,
        'SrvDriveAssistOn': True,
        'FsdMassLockEscaped': True,
        'FsdMassLocked': True,
        ...
        'GlideModeExited': True,
        'GlideModeEntered': True,
        'BreathableAtmosphereExited': True,
        'BreathableAtmosphereEntered': True,
