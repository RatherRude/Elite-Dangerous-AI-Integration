...
SCANCODE = {
    ...
    'DIK_RCONTROL'        : 0x9D,
    'DIK_NUMPAD_COMMA'    : 0xB3,    # , on numeric keypad (NEC PC98) */
    ...
    'DIK_NUMPAD_STAR'     : 0x37,        # * on numeric keypad */
    'DIK_LALT'            : 0x38,           # left Alt */
    'DIK_CAPSLOCK'        : 0x3A,         # CapsLock */
    'DIK_NUMPAD_MINUS'    : 0x4A,        # - on numeric keypad */
    'DIK_NUMPAD_PLUS'     : 0x4E,             # + on numeric keypad */
    'DIK_NUMPAD_PERIOD'   : 0x53,         # . on numeric keypad */
    'DIK_NUMPAD_SLASH'    : 0xB5,          # / on numeric keypad */
