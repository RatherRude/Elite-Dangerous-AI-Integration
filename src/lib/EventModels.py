...
# ColonisationConstructionDepot: 68200 characters, 25 entries
class ColonisationConstructionDepotEventResourcesrequiredItem(TypedDict):
    Name_Localised: str
    Name: str
    Payment: int
    RequiredAmount: int
    ProvidedAmount: int
class ColonisationConstructionDepotEvent(TypedDict):
    timestamp: str
    ConstructionComplete: bool
    MarketID: Literal[3957041922]
    ConstructionProgress: float
    event: Literal["ColonisationConstructionDepot"]
    ConstructionFailed: bool
    ResourcesRequired: list[ColonisationConstructionDepotEventResourcesrequiredItem]
