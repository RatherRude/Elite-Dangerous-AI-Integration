...
game_events = {
    ...
    'WingLeave': True,
    'SendText': False,
    'ReceiveTextChannelLocal': False,
    'ReceiveTextChannelStarSystem': False,
    'ReceiveTextChannelSquadron': False,
    'ReceiveTextStation': False,
    'ReceiveTextPolice': False,
    'ReceiveTextDockingChatter': False,
    'ReceiveTextMilitary': False,
    'ReceiveTextCruiseLiner': False,
    'ReceiveTextCommuter': False,
    'ReceiveTextAX': False,
    'ReceiveTextTrader': False,
    'ReceiveTextPirate': False,
    'ReceiveTextPowers': False,
    'ReceiveTextMiner': False,
    'ReceiveTextExplorer': False,
    'ReceiveTextSmuggler': False,
    'ReceiveTextPassengerLiner': False,
    'ReceiveTextEscort': False,
    'ReceiveTextHitman': False,
    'ReceiveTextPropagandist': False,
    'ReceiveTextRescuer': False,
    'ReceiveTextConvoy': False,
    'ReceiveTextRefugeeFlotillaWar': False,
    'ReceiveTextProtester': False,
    'ReceiveTextOther': False,
