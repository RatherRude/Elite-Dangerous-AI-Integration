...
class Chat:
    def __init__(self, config: Config):
        ...
        self.copilot = EDCoPilot(self.config["edcopilot"], is_edcopilot_dominant=self.config["edcopilot_dominant"],
                            game_events=self.config["game_events"])
        ...
        self.prompt_generator = PromptGenerator(self.config["commander_name"], self.config["character"], important_game_events=enabled_game_events, game_events=config["game_events"])
    ...
    def run(self):
        ...
        registerProjections(self.event_manager, self.config)
